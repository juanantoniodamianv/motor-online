...
export default function PublicationsFilter() {
  async function search(formData: FormData) {
    ...
    const redirectUrl = `/?search=${searchValue}`;
  ...
  return (
    <div className="mx-auto max-w-5xl w-full mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:p-8">
      <form action={search}>
        <div className="mb-4">
      ...
      <form action={filter}>
        <div className="grid grid-cols-1">
          ...
          <label
            htmlFor="toggle"
            className="no-select mb-4 label-text cursor-pointer text-green-700 hover:text-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm dark:text-green-400 dark:hover:text-green-500 dark:focus:ring-green-900"
          >
          ...
          <div className="peer-checked:block hidden">
            ...
            <div className="mb-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  <Radio id="usd" name="currencyType" value="usd" />
